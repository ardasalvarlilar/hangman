...
const words = ['application','programming','interface','wizard','nodejs']
...
function gameOver(){
  ...
  popup.style.display = 'flex'
  window.removeEventListener('keydown',detactKeys)
}
...
window.addEventListener('keydown',detactKeys)
displayWord()